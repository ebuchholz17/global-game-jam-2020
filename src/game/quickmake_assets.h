...
enum data_key {
    DATA_KEY_HITBOX_STANDING_BLOCK_O,
    DATA_KEY_HITBOX_STANDING_BLOCK_X,
    DATA_KEY_HITBOX_STANDING_BLOCK_WALK_O,
    DATA_KEY_HITBOX_STANDING_BLOCK_WALK_X,
    DATA_KEY_HITBOX_STANDING_HIT_O,
    DATA_KEY_HITBOX_STANDING_HIT_X,
    DATA_KEY_HITBOX_STANDING_IDLE_0,
    DATA_KEY_HITBOX_STANDING_IDLE_X,
    DATA_KEY_HITBOX_STANDING_PUNCH_O,
    DATA_KEY_HITBOX_STANDING_PUNCH_X,
    DATA_KEY_HITBOX_STANDING_WALK_0,
    DATA_KEY_HITBOX_STANDING_WALK_X,
    DATA_KEY_HITBOX_STANDING_KICK_O,
    DATA_KEY_HITBOX_STANDING_KICK_X,
    DATA_KEY_HITBOX_CROUCHING_BLOCK_O,
    DATA_KEY_HITBOX_CROUCHING_BLOCK_X,
    DATA_KEY_HITBOX_CROUCHING_HIT_O,
    DATA_KEY_HITBOX_CROUCHING_HIT_X,
    DATA_KEY_HITBOX_CROUCHING_IDLE_O,
    DATA_KEY_HITBOX_CROUCHING_IDLE_X,
    DATA_KEY_HITBOX_CROUCHING_KICK_O,
    DATA_KEY_HITBOX_CROUCHING_KICK_X,
    DATA_KEY_HITBOX_CROUCHING_PUNCH_O,
    DATA_KEY_HITBOX_CROUCHING_PUNCH_X,
    DATA_KEY_HITBOX_JUMP_KICK_O,
    DATA_KEY_HITBOX_JUMP_KICK_X,
    DATA_KEY_HITBOX_JUMP_O,
    DATA_KEY_HITBOX_JUMP_X,
    DATA_KEY_HITBOX_JUMP_PUNCH_O,
    DATA_KEY_HITBOX_JUMP_PUNCH_X,
    DATA_KEY_HITBOX_HIT_AIR_O,
    DATA_KEY_HITBOX_HIT_AIR_X
};
